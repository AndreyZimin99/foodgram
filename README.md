#  Foodgram
   В данном проекте я реализовал работу с API, настройку баз данных и аутентификацию пользователей. Также составил dockerfile для бэкэнда, docker-compose и workflow.
